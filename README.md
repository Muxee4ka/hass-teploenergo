...
Подключает [личный кабинет Теплоэнерго НН](https://mobilelk.oko-nn.ru) к Home Assistant: отображение задолженности, начислений и показаний приборов учёта, передача показаний счётчиков и скачивание квитанций. Авторизация — по e-mail и паролю от мобильного приложения.
